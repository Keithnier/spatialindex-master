...
public class Whynot_3_new {
	...
	public static void main(String[] args) throws Exception{
		...
		int[] top_k = {30,100,300};
		PrintWriter bw = new PrintWriter("Varing_k0_Alg3_result_test.txt");
       for(int round = 0; round <=4; round++) {
		...
		bw.println("Millisecond time cost by Algorithm III : " + avg);
