...
public class Run_together {
	...
	public static void main(String[] args) throws Exception{
			...
			int[] initial_vector = {1,3,5,7,9};
			PrintWriter bw = new PrintWriter("Varing_initial_weight_vector_result.txt");
	       ...
	       for(int round = 0; round <=4; round++) {
		        ...
		        bw.println();
		        bw.println("=============================================================================");
			    bw.println("Initial weight vector :  0." + initial_vector[round]);
				String query_file = "1000_euro_4word_m101_a0."+initial_vector[round]+".txt";
				...
				String[] temp;
				double c = 1;
				double penalty_alpha = 0.5;
				
				double alpha = (double) initial_vector[round]/10;
	            //Alg I
				bw.println("Alg I : ");
				...
				while((line = querybr1.readLine()) != null){
					...
					irtree.answeringWhyNot_111(qwords, qpoint, l, penalty_alpha, c);
				...
				while((line = querybr2.readLine()) != null){
					...
					irtree.answeringWhyNot_222(qwords, qpoint, topk, expected_ob, alpha, penalty_alpha, c);
				...
				while((line = querybr3.readLine()) != null){
					...
					irtree.answeringWhyNot_3_new(qwords, qpoint, topk, expected_ob, alpha, penalty_alpha, c);
		...
		//Whynot_numberquerykeywords().main(args);
			int[] number_keywords = {2,4,8,16,32};
			bw = new PrintWriter("Varing_num_keywords_result.txt");
		...
		//new Whynot_penalty_alpha().main(args);
			double[] penalty_alpha_list = {0.1, 0.3, 0.5, 0.7, 0.9};
			bw = new PrintWriter("Varing_penalty_alpha.txt");
			
	       for(int round = 0; round <=4; round++) {
	    	
		        bw.println();
		        bw.println("=============================================================================");
			    bw.println("Penalty_alpha : " + penalty_alpha_list[round]);
				String query_file = "1000_euro_4word_m101.txt";
				double[] f = new double[2];
				Vector qwords = new Vector();
				int count = 0;
				int expected_ob = 0;
				...
				double penalty_alpha = penalty_alpha_list[round];
		...
		//new Whynot_initial_rank_of_missing().main(args);
			int[] initial_missing_rank = {31,101,301,1001,3001};
			bw = new PrintWriter("Varing_initial_rank_of_missing.txt");
	       ...
	       for(int round = 0; round <=4; round++) {
		        ...
		        bw.println();
		        bw.println("=============================================================================");
			    bw.println("Missing object's initial rank is " + initial_missing_rank[round] + " : ");
				String query_file = "1000_euro_4word_m"+initial_missing_rank[round]+".txt";
				double[] f = new double[2];
				Vector qwords = new Vector();
				int count = 0;
				int expected_ob = 0;
