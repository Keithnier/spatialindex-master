...
public class Whynot_initial_rank_of_missing {
	...
	public static void main(String[] args) throws Exception{
		...
		PrintWriter bw = new PrintWriter("Varing_initial_rank_of_missing.txt");
		
       for(int round = 4; round <=4; round++) {
			...
			*/
			...
			while((line = querybr2.readLine()) != null){
				...
				count++;
			    if(count==numofquery) break;
			    bw.println("count avg_io avg_time : " + count + " " + (io_total/count) + " " + (time_total/count));
			    bw.flush();
			}
